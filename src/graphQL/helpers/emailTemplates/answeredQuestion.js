exports.emailTemplate = (name, question) => {
  return `
  <div>
    <h1 style="width: 65%; display: block; margin: 0 auto; margin-top: 30px;font-size: 20px; text-align: center;font-family: Helvetica; color: rgb(80, 80, 90); font-weight: lighter;">Hey ${ name } you asked a question recently. <b>${ question.title }</b>. Someone just answered your question!</h1>
