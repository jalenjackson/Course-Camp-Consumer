exports.emailTemplate = (name, amount) => {
  return `
  <div>
    <h1 style="display: block; margin: 0 auto; margin-top: 30px;font-size: 20px; text-align: center;font-family: Helvetica; color: rgb(80, 80, 90); font-weight: lighter;">Hey ${ name } your PayPal transfer of $${ amount } was completed!</h1>
